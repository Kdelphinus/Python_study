...
def plot_vector(vectors, tails=None):
    ...
    if nvectors == 1 and ntails > 1:
        ...
        assert (
            tails.shape == vectors.shape
        ), "vectors and tail must have a same shape"
...
def plot_transformation_helper(
    ...
    *vectors : class numpy.ndarray.
    ...
    if unit_vector:
        axis.quiver(
            origin, origin, [I[0]], [I[1]], color=green, **quiver_params
        )
...
def plot_linear_transformation(
    matrix, *vectors, unit_vector=True, unit_circle=False
):
...
@set_rc
def plot_basis_helper(
    axis, I, J, *vectors, title=None, I_label="i", J_label="j"
):
    ...
    *vectors : class numpy.ndarray.
    ...
    axis.quiver(
        origin, origin, [J[0]], [J[1]], color=lightblue, **quiver_params
    )
